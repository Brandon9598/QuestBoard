...
function Home() {
    ...
    <div>
        ...
        <section className="bg-light text-dark pt-5 text-center">
            <div className="container">
                <div className="d-flex">
                    <div>
                        <h3>What is <span className="text-primary">QuestBoard</span>?</h3>
                    ...
                    <div className="col-md">
                        <div className="card bg-light text-dark">
                            <div className="card-body text-center">
                                ...
                                <a href="#" className="btn btn-success">Create Account</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section className="p-5 bg-primary">
            <p className="text-light">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquid ut provident minus ullam aperiam, nemo, officiis quod repudiandae sunt repellat reiciendis deserunt impedit? Quis adipisci soluta illo ipsam explicabo perspiciatis.</p>
        </section>
